...
window.PROCESOS = (function(){
  ...
  function amasar(){
    return [
      ...
      { t:'pasos', items:[
        'Pon la masa sobre la mesa. <b>Usá la base de la palma, no los dedos.</b> Los dedos pellizcan; la palma empuja.',
        'Empuja la masa hacia adelante <b>con el peso del cuerpo</b>, no con la fuerza del brazo. Si te cansas en 5 minutos, estás usando el brazo.',
        '<b>Dóblala sobre sí misma</b>, trayendo la punta de vuelta hacia vos.',
        '<b>Gira 90 grados</b> — un cuarto de vuelta — y repite.',
      ...
      { t:'seq', titulo:'El movimiento, de cerca', items:[
        ['tec-amasar-empujar','<b>Empujar.</b> Con el talón de la palma, hacia adelante. Fíjate que no son los dedos.'],
        ['tec-amasar-doblar','<b>Doblar.</b> Traes la punta de vuelta sobre sí misma.'],
        ['tec-amasar-girar','<b>Girar.</b> Un cuarto de vuelta, y vuelves a empezar.']
      ]},
      ...
      { t:'seq', titulo:'Cómo se ve la masa en cada momento', items:[
        ...
        ['tec-masa-min20','<b>Minuto 20.</b> Lisa, tersa y con brillo. Ahí paras.']
      ]},
      { t:'tip', tt:'Puedes descansar, y conviene', c:'Parar <b>1 o 2 minutos cada 10</b> no es hacer trampa: mientras descansas vos, el gluten se relaja y el resto del amasado cuesta menos. Y si la masa se te pega demasiado, no le eches harina — <b>agárrala de los extremos, golpéala contra la mesa, dóblala y gira 90°</b> durante 10 o 15 minutos. Eso desarrolla el gluten sin secar la masa.' },
      { t:'nota', tt:'Cómo saber que terminaste: la ventana de gluten', c:'Corta un trocito y estíralo despacio entre los dedos. <b>Si se hace una lámina tan fina que se ve la luz a través, sin romperse, terminaste.</b> Si se rompe antes, le faltan minutos. Es la única prueba que vale: el reloj es orientativo, la ventana es la verdad.' }
    ];
  }
  ...
  function fermentar1(conLevadura){
    return [
      ...
      { t:'p', c: conLevadura
        ? 'Acá no haces nada. La masa trabaja sola: la levadura se come los azúcares y suelta el gas que la infla.'
        : 'Acá no haces nada. La masa trabaja sola: la talvina se come los azúcares y suelta el gas que la infla.' },
      { t:'pasos', items:[
        'Bolea la masa sin apretarla y ponla en un bol.',
        '<b>Tápala</b> con un paño o con film, para que no se le seque la superficie.',
        'Déjala en un lugar sin corriente de aire.',
      ...
      { t:'nota', tt:'Por qué 60 en un lado y 90 en otro', c:'Porque manda la temperatura de tu cocina, no el reloj. <b>En cocina caliente puede estar a los 60 minutos; en cocina fría se va a los 90 o más.</b> Míralo a los 60 y decide con los ojos: si dobló, sigue; si no, espera y vuelve a mirar cada 15 minutos.' }
    ];
  }
  ...
  function desgasificar(pieza){
    return [
      ...
      { t:'pasos', items:[
        'Con <b>la palma abierta</b>, presiona la masa hacia abajo con movimientos suaves y circulares.',
        ...
        'Pesa la masa entera y divídela <b>con báscula</b>, en piezas de <b>' + pieza + '</b>. A ojo no: piezas de distinto peso se hornean distinto y unas salen crudas y otras quemadas.',
        'Corta con rasqueta o cuchillo, <b>de un corte limpio</b>, sin desgarrar.'
      ]},
  ...
  function preformar(pieza){
    return [
      ...
      { t:'pasos', items:[
        'Con cada porción de ' + pieza + ' haz <b>una bola suave, sin apretar</b>.',
        'Ponlas en la mesa separadas y <b>cúbrelas</b>.',
        'Déjalas <b>10 a 15 minutos</b>. Sin este descanso la masa se resiste, y cuando la estiras se encoge sola como un elástico.'
      ]},
  ...
  function fermentar2(min, juntos){
    ...
    return [
      ...
      { t:'pasos', items:[
        juntos
          ? 'Acomoda las piezas en la bandeja <b>casi tocándose, a 1 cm</b>. Este es el único pan del catálogo donde se buscan los costados pálidos: al crecer se pegan entre sí y quedan tiernos por los lados.'
          : 'Acomoda las piezas en la bandeja <b>separadas 4 cm como mínimo</b>, para que crezcan sin tocarse.',
        'Cúbrelas con un <b>paño húmedo que no toque la masa</b>, o con film dejando espacio.',
        'Espera <b>' + min + ' minutos</b>. Crecen entre el 60 y el 80% de su tamaño final.',
        '<b>Aprovecha y precalienta el horno ahora</b>, 30 minutos antes de hornear.'
      ]},
      ...
      { t:'nota', tt:'La prueba del dedo: cuándo va al horno', c:'Presiona suave con un dedo. <b>Si la marca vuelve despacio, está listo.</b> Si vuelve rápido, le falta tiempo. <b>Si no vuelve, se pasó</b> — al horno ya mismo, porque si esperas más se te derrumba adentro.' }
    ];
  }
  ...
  function hornear(h){
    ...
    return [
      ...
      { t:'pasos', items:[
        ...
        'A partir del minuto ' + Math.max(1, h.min - 2) + ', mira cada 2 o 3 minutos.',
        'Saca cuando pase las pruebas de abajo, no cuando suene el timer.'
      ])},

      { t:'h', c:'Cómo saber que ya está, sin adivinar' },
      { t:'lista', items:[
        ['La prueba del golpe','Golpea la base con los nudillos. <b>Sonido hueco = listo.</b> Sonido sordo = le falta tiempo. Es la más rápida y la primera que aprende todo panadero.'],
        ...
        ['La base','Debe estar dorada pareja. Si está pálida, voltéalo y dale 3 a 5 minutos más: al horno le faltó calor por abajo.']
      ]},
      ...
      { t:'nota', tt:'El falso dorado, el error más peligroso', c:'Si la corteza se dora muy rápido, el horno está demasiado caliente y el pan queda <b>perfecto por fuera y crudo por dentro</b>. Si el color llega antes del tiempo mínimo: <b>cubre con papel aluminio y baja 10 °C</b>. Un pan bien horneado alcanza el color justo cuando alcanza la temperatura interna.' }
    ];
  }
  ...
  function conservar(){
    return [
      ...
      { t:'tabla', cols:['Cómo lo guardas','Cuánto dura'], filas:[
